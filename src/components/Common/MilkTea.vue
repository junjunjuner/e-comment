...
<style scoped>
  ...
  .face-mouth {
    ...
    left: 75px;
    top: 48px;
    -webkit-animation: mouth 5s infinite;
  ...
  .face-blush {
    ...
    border-radius: 100%;
    z-index: 2;
    -webkit-animation: blush 5s infinite;
  ...
  .like {
    ...
    align-items: center;
    font-size: 41px;
    -webkit-animation: heart 3.5s infinite;
  ...
  @-webkit-keyframes eyes {
    ...
    24%, 60% {
      -webkit-transform: translate(-3px, -11px) scale(1.05, 0.5);
  ...
  @-webkit-keyframes mouth {
    ...
    15%, 55% {
      -webkit-transform: translate(-1px, -15px) scale(1.1, 0.9);
